...
export const Step0 = (props) => {
  const { nextStep, setUsername, setMail, setRepassword, setPassword } = props;
      ...
      <div className="flex justify-center items-center w-[50%]">
        <div className={` flex w-auto flex-col gap-[40px]`}>
          ...
          <div>
            <button
              onClick={nextStep}
              className="btn text-white bg-[#0166FF] w-full"
            >
              Sign Up
            </button>
          </div>
          <div className="text-center flex gap-[10px] justify-center">
            ...
            <a href="/logIn" className="link link-hover text-[#0166FF]">
              Log in
            </a>
          </div>
        </div>
      </div>
      <div className="flex w-[50%] h-[100vh] bg-[#0166FF]"></div>
    </div>
  );
};
